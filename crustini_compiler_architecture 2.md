...
```bash
crustini check examples/ball.crst
crustini emit examples/ball.crst --out build/generated
crustini run examples/ball.crst
```
...
```bash
crustini build examples/ball.crst --target esp32s3
...
```bash
crustini emit examples/ball.crst --out build/ball
```
