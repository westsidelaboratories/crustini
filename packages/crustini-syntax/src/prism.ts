...
export function registerCrsPrism(Prism: typeof PrismType) {
  Prism.languages.crs = {
    ...
    declaration: /\b(?:app|name|target|display|input|button|state|screen|fps|setup|update|draw|on|every|const|goto)\b/,
    ...
    builtin: /\b(?:clear|pixel|line|rect|fill_rect|circle|text|bitmap|sprite|flush|progress|menu|card|meter|toggle|slider|redraw|min|max|clamp)\b/,
